...
" Dark background {{{2
	...
	hi OL1 guifg=white	    ctermfg=221 
	hi OL2 guifg=red	    ctermfg=31
	hi OL3 guifg=lightblue	ctermfg=96
	hi OL4 guifg=darkviolet	ctermfg=143
	hi OL5 guifg=white	    ctermfg=111
	hi OL6 guifg=red	    ctermfg=103
	hi OL7 guifg=lightblue	ctermfg=79
	hi OL8 guifg=darkviolet	ctermfg=63
	hi OL9 guifg=white	    ctermfg=39

	" colors for tags
	hi outlTags guifg=darkred	ctermfg=darkred

	" color for body text
	hi BT1 guifg=darkgreen	ctermfg=221
	hi BT2 guifg=darkgreen	ctermfg=31
	hi BT3 guifg=darkgreen	ctermfg=96
	hi BT4 guifg=darkgreen	ctermfg=143
	hi BT5 guifg=darkgreen	ctermfg=111
	hi BT6 guifg=darkgreen	ctermfg=103
	hi BT7 guifg=darkgreen	ctermfg=79
	hi BT8 guifg=darkgreen	ctermfg=63
	hi BT9 guifg=darkgreen	ctermfg=39

	" color for pre-formatted text
	hi PT1 guifg=darkblue	ctermfg=221
	hi PT2 guifg=darkblue	ctermfg=31
	hi PT3 guifg=darkblue	ctermfg=96
	hi PT4 guifg=darkblue	ctermfg=143
	hi PT5 guifg=darkblue	ctermfg=111
	hi PT6 guifg=darkblue	ctermfg=103
	hi PT7 guifg=darkblue	ctermfg=79
	hi PT8 guifg=darkblue	ctermfg=63
	hi PT9 guifg=darkblue	ctermfg=39

	" color for tables 
	hi TA1 guifg=darkviolet	ctermfg=221
	hi TA2 guifg=darkviolet	ctermfg=31
	hi TA3 guifg=darkviolet	ctermfg=96
	hi TA4 guifg=darkviolet	ctermfg=143
	hi TA5 guifg=darkviolet	ctermfg=111
	hi TA6 guifg=darkviolet	ctermfg=103
	hi TA7 guifg=darkviolet	ctermfg=79
	hi TA8 guifg=darkviolet	ctermfg=63
	hi TA9 guifg=darkviolet	ctermfg=39

	" color for user text (wrapping)
	hi UT1 guifg=darkred	ctermfg=221
	hi UT2 guifg=darkred	ctermfg=31
	hi UT3 guifg=darkred	ctermfg=96
	hi UT4 guifg=darkred	ctermfg=143
	hi UT5 guifg=darkred	ctermfg=111
	hi UT6 guifg=darkred	ctermfg=103
	hi UT7 guifg=darkred	ctermfg=79
	hi UT8 guifg=darkred	ctermfg=63
	hi UT9 guifg=darkred	ctermfg=39

	" color for user text (non-wrapping)
	hi UB1 guifg=darkgray	ctermfg=221
	hi UB2 guifg=darkgray	ctermfg=31
	hi UB3 guifg=darkgray	ctermfg=96
	hi UB4 guifg=darkgray	ctermfg=143
	hi UB5 guifg=darkgray	ctermfg=111
	hi UB6 guifg=darkgray	ctermfg=103
	hi UB7 guifg=darkgray	ctermfg=79
	hi UB8 guifg=darkgray	ctermfg=63
	hi UB9 guifg=darkgray	ctermfg=39
...
syntax match Fin "\[X\]" containedin=ALL
syntax match uFin "\[_\]" containedin=ALL

hi Fin  ctermfg=darkgreen
hi uFin ctermfg=DarkRed
